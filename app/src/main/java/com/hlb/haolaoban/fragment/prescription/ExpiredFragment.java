...
public class ExpiredFragment extends BaseFragment2 implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static ExpiredFragment getInstance(String type) {
        ExpiredFragment unPayFragment = new ExpiredFragment();
